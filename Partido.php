...
class Partido
{
    ...
    {
        $salida = $this->getObjEquipo1() . " " . $this->getObjEquipo2(); // si Empatan (No entra al if)

        if ($this->getCantGolesE1() > $this->getCantGolesE2()) { // si gana el equipo 1
            $salida = $this->getObjEquipo1();
        } else { // si gana el equipo 2
            $salida = $this->getObjEquipo2();
        }
        return $salida;
    }
    ...
    {
        $golesTotal = $this->getCantGolesE1() + $this->getCantGolesE2();

        $jugadoresTotales = $this->getObjEquipo1()->getCantJugadores + $this->getObjEquipo1()->getCantJugadores;
        
        $salida = $this->getCoefBase() * $golesTotal * $jugadoresTotales;
        return $salida;
    }
}
